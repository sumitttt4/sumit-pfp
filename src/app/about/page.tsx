            ...
            <div className="pt-8 border-t border-zinc-200 dark:border-zinc-800/80 space-y-4">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                    <a
                        ...
                        className="flex items-center gap-2.5 px-4 py-2 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-900 text-zinc-700 dark:text-zinc-300 text-sm font-medium transition-colors group"
                    >
