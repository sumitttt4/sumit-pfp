    ...
    return (
        ...
        >
            ...
            <div className="space-y-5 text-[15px] text-zinc-800 dark:text-zinc-300 font-normal leading-relaxed">
                ...
                <p>
                    Today I&apos;m building <a href="https://glyph.software" target="_blank" rel="noreferrer" className="text-brandAccent hover:text-brandAccent-hover font-medium hover:underline whitespace-nowrap">Glyph</a>, an AI-powered brand identity generator, while also running <a href="https://fedup.studio" target="_blank" rel="noreferrer" className="text-brandAccent hover:text-brandAccent-hover font-medium hover:underline whitespace-nowrap">FedUp Studio</a> where I help startups design and build modern digital products.
                </p>
                <p>
