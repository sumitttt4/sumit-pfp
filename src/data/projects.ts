...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "UI Library",
    image: "/kinetik.png",
    link: "https://www.kinetik.ink/",
    description: "A modern, open-source UI component library for building beautiful interfaces",
    impact: "Open Source",
    overview: "Kinetik is a modern UI component library designed for developers who want to build beautiful, accessible interfaces with minimal effort. It provides a collection of pre-built, customizable components that follow best practices in design and accessibility.\n\nProblem: Building consistent, well-designed UI components from scratch is time-consuming. Existing libraries often feel generic or are overly opinionated, forcing developers into rigid design patterns.\n\nUser: Frontend developers and design engineers who want high-quality, flexible UI primitives that look great out of the box.\n\nOutcome: A curated set of production-ready components that balance aesthetics with developer experience.",
    process: "Role: Creator & Lead Engineer | Type: Open Source Library | Stack: React, TypeScript, CSS.\n\nDesign Principle: Beautiful defaults, infinite flexibility. Every component should look stunning with zero configuration but be deeply customizable.\n\nKey Design Decisions: Focused on motion and micro-interactions as first-class citizens. Every component has thoughtful enter/exit animations built in.\n\nEngineering Decisions: Tree-shakeable architecture ensures only the components you use end up in your bundle. Zero runtime CSS-in-JS for optimal performance."
  },
  {
    id: 6,
    title: "SafeAgree",
  ...
  },
  {
    ...
    screenshots: ["/vibe-market-submit.png"],
